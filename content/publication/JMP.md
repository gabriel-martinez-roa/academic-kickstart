...
#abstract_short = "I extend the classic model of Bayesian persuasion (Kamenica and Gentzkow, 2011) to allow for uncertainty about the source of information. There are multiple senders that can differ in their objectives, or in their information, and the receiver has uncertainty about the source of the message received. I show that whenever biased information is inevitable, news platforms have incentives to exert editorial power and limit, though not eliminate, the frequency of opinions that try to confuse the audience. Similarly, presenting a receiver with opposed views without requiring to disclose their bias, is less informative than having a source with a known biased perspective."
